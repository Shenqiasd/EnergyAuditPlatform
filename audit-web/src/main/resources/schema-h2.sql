...
CREATE TABLE IF NOT EXISTS ent_enterprise_setting (
    ...
    energy_usage_type        VARCHAR(50),
    energy_leader_title      VARCHAR(50),
    energy_dept_name         VARCHAR(100),
    energy_audit_contact_name  VARCHAR(50),
    energy_audit_contact_phone VARCHAR(30),
    remark                   VARCHAR(512),
    create_by                VARCHAR(64),
    create_time              DATETIME      NOT NULL DEFAULT CURRENT_TIMESTAMP,
    update_by                VARCHAR(64),
...
CREATE TABLE IF NOT EXISTS de_energy_consumption (
    ...
    nameplate_output       VARCHAR(128),
    main_energy_name       VARCHAR(128),
    main_energy_consumption DECIMAL(18,4),
    avg_operating_efficiency DECIMAL(18,6),
    residual_heat_energy   DECIMAL(18,4),
    available_residual_heat_energy DECIMAL(18,4),
    utilized_residual_heat_energy DECIMAL(18,4),
    recovery_utilization_rate DECIMAL(18,6),
    statistical_load_rate  DECIMAL(18,6),
    test_efficiency        DECIMAL(18,6),
    flue_gas_loss_rate     DECIMAL(18,6),
    heat_loss_rate         DECIMAL(18,6),
    other_loss             DECIMAL(18,6),
    test_date              DATE,
    measurement_unit       VARCHAR(32),
...
CREATE TABLE IF NOT EXISTS de_product_unit_consumption (
    ...
    numerator_unit            VARCHAR(32),
    denominator_unit          VARCHAR(32),
    year_type                 VARCHAR(16),
    measurement_unit          VARCHAR(32),
    output                    DECIMAL(18,4),
    energy_consumption        DECIMAL(18,4),
    unit_consumption          DECIMAL(18,6),
    prev_unit_consumption     DECIMAL(18,6),
    prev_energy_consumption   DECIMAL(18,4),
    prev_output               DECIMAL(18,4),
    create_by                 VARCHAR(64),
    create_time               DATETIME      NOT NULL DEFAULT CURRENT_TIMESTAMP,
    update_by                 VARCHAR(64),
    update_time               DATETIME      NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- de_equipment_benchmark (重点用能设备能效对标)
CREATE TABLE IF NOT EXISTS de_equipment_benchmark (
    id                          BIGINT        NOT NULL AUTO_INCREMENT,
    enterprise_id               BIGINT        NOT NULL,
    audit_year                  INT           NOT NULL,
    ...
    is_obsolete                 VARCHAR(16)   DEFAULT NULL,
    annual_runtime_hours        DECIMAL(10,2) DEFAULT NULL,
    factory_mgmt_no             VARCHAR(128)  DEFAULT NULL,
    install_location            VARCHAR(256)  DEFAULT NULL,
    manufacture_date            VARCHAR(64)   DEFAULT NULL,
    motor_type                  VARCHAR(128)  DEFAULT NULL,
    motor_model                 VARCHAR(128)  DEFAULT NULL,
    motor_rated_power           DECIMAL(12,2) DEFAULT NULL,
    motor_poles                 VARCHAR(32)   DEFAULT NULL,
    motor_rated_speed           VARCHAR(64)   DEFAULT NULL,
    motor_rated_efficiency      DECIMAL(8,2)  DEFAULT NULL,
    motor_cooling_method        VARCHAR(64)   DEFAULT NULL,
    motor_efficiency_grade      VARCHAR(32)   DEFAULT NULL,
    rated_current               DECIMAL(12,2) DEFAULT NULL,
    rated_voltage               VARCHAR(32)   DEFAULT NULL,
    motor_power_factor          DECIMAL(6,4)  DEFAULT NULL,
    energy_grade                VARCHAR(32)   DEFAULT NULL,
    pump_type                   VARCHAR(128)  DEFAULT NULL,
    pump_sub_type               VARCHAR(128)  DEFAULT NULL,
    pump_rated_head             DECIMAL(10,2) DEFAULT NULL,
    pump_flow_rate              DECIMAL(12,2) DEFAULT NULL,
    pump_speed                  VARCHAR(64)   DEFAULT NULL,
    pump_shaft_power            DECIMAL(12,2) DEFAULT NULL,
    pump_stages                 VARCHAR(32)   DEFAULT NULL,
    pump_efficiency             DECIMAL(8,2)  DEFAULT NULL,
    pump_pressure               DECIMAL(10,4) DEFAULT NULL,
    pump_work_temp              VARCHAR(64)   DEFAULT NULL,
    compressor_type             VARCHAR(128)  DEFAULT NULL,
    compressor_model            VARCHAR(128)  DEFAULT NULL,
    compressor_rated_motor_power DECIMAL(12,2) DEFAULT NULL,
    compressor_discharge_pressure DECIMAL(10,4) DEFAULT NULL,
    compressor_volume_flow      DECIMAL(12,4) DEFAULT NULL,
    compressor_specific_power   DECIMAL(12,4) DEFAULT NULL,
    compressor_cooling          VARCHAR(64)   DEFAULT NULL,
    compressor_heat_recovery    VARCHAR(16)   DEFAULT NULL,
    compressor_stages           VARCHAR(32)   DEFAULT NULL,
    compressor_name             VARCHAR(128)  DEFAULT NULL,
    fan_type                    VARCHAR(128)  DEFAULT NULL,
    fan_model                   VARCHAR(128)  DEFAULT NULL,
    fan_total_pressure          DECIMAL(12,2) DEFAULT NULL,
    fan_air_volume              DECIMAL(12,2) DEFAULT NULL,
    fan_pressure_coeff          VARCHAR(64)   DEFAULT NULL,
    fan_specific_speed          VARCHAR(64)   DEFAULT NULL,
    fan_size_no                 VARCHAR(64)   DEFAULT NULL,
    fan_hub_ratio               VARCHAR(64)   DEFAULT NULL,
    fan_efficiency              DECIMAL(8,2)  DEFAULT NULL,
    fan_pressure_pa             DECIMAL(12,2) DEFAULT NULL,
    ac_type                     VARCHAR(128)  DEFAULT NULL,
    ac_unit_type                VARCHAR(256)  DEFAULT NULL,
    ac_model                    VARCHAR(128)  DEFAULT NULL,
    ac_cooling_capacity         DECIMAL(12,2) DEFAULT NULL,
    ac_cop                      DECIMAL(8,4)  DEFAULT NULL,
    ac_iplv                     DECIMAL(8,4)  DEFAULT NULL,
    ac_steam_consumption        DECIMAL(12,4) DEFAULT NULL,
    ac_steam_pressure           VARCHAR(64)   DEFAULT NULL,
    boiler_type                 VARCHAR(128)  DEFAULT NULL,
    boiler_capacity             VARCHAR(128)  DEFAULT NULL,
    boiler_fuel_type            VARCHAR(128)  DEFAULT NULL,
    boiler_thermal_eff          DECIMAL(8,2)  DEFAULT NULL,
    boiler_heat_recovery        VARCHAR(16)   DEFAULT NULL,
    boiler_rated_pressure       DECIMAL(10,4) DEFAULT NULL,
    boiler_rated_temp           DECIMAL(8,2)  DEFAULT NULL,
    boiler_inlet_temp           DECIMAL(8,2)  DEFAULT NULL,
    boiler_fuel_consumption     DECIMAL(12,4) DEFAULT NULL,
    boiler_fuel_heat_value      DECIMAL(12,4) DEFAULT NULL,
    boiler_exhaust_temp         DECIMAL(8,2)  DEFAULT NULL,
    transformer_voltage         VARCHAR(32)   DEFAULT NULL,
    transformer_type            VARCHAR(256)  DEFAULT NULL,
    transformer_capacity        DECIMAL(12,2) DEFAULT NULL,
    transformer_core_material   VARCHAR(64)   DEFAULT NULL,
    transformer_insulation      VARCHAR(32)   DEFAULT NULL,
    transformer_connection      VARCHAR(64)   DEFAULT NULL,
    transformer_no_load_loss    DECIMAL(12,2) DEFAULT NULL,
    transformer_load_loss       DECIMAL(12,2) DEFAULT NULL,
    transformer_model           VARCHAR(128)  DEFAULT NULL,
    transformer_grade_ref       VARCHAR(256)  DEFAULT NULL,
