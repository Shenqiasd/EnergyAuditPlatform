...
const columns: RegColumn[] = [
  ...
  { prop: 'managementNo', label: '管理编号', minWidth: 100 },
  ...
  { prop: 'multiplier', label: '倍率', width: 80 },
  { prop: 'grade', label: '级别', width: 80 },
  { prop: 'energyId', label: '能源属性', minWidth: 100 },
  { prop: 'measureRange', label: '测量范围', minWidth: 100 },
