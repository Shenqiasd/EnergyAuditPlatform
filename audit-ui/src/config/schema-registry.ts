...
export const SCHEMA_REGISTRY: Record<string, TableSchema> = {
  de_company_overview: {
    label: '企业概况',
    fields: {
      energy_leader_name:     { label: '节能主管领导姓名', type: 'STRING' },
      energy_leader_position: { label: '节能主管领导职务', type: 'STRING' },
      energy_dept_name:       { label: '节能主管部门名称', type: 'STRING' },
      energy_dept_leader:     { label: '部门负责人姓名', type: 'STRING' },
      fulltime_staff_count:   { label: '专职管理人员数', type: 'NUMBER' },
      parttime_staff_count:   { label: '兼职管理人员数', type: 'NUMBER' },
      five_year_target_value: { label: '十四五节能目标值', type: 'DECIMAL' },
      five_year_target_name:  { label: '十四五节能目标名称', type: 'STRING' },
      five_year_target_dept:  { label: '目标下达部门', type: 'STRING' },
    },
  },
  ...
  de_tech_indicator: {
    ...
    fields: {
      ...
      coal_target:                { label: '煤炭消费总量目标', type: 'DECIMAL' },
      coal_actual:                { label: '煤炭消费实际完成值', type: 'DECIMAL' },
    },
  },
  ...
  de_meter_config_rate: {
    label: '能源计量器具配备率',
    fields: {
      energy_type:    { label: '能源种类', type: 'DICT' },
      level_type:     { label: '层级', type: 'NUMBER' },
      required_count: { label: '需要配置数', type: 'NUMBER' },
      actual_count:   { label: '实际配置数', type: 'NUMBER' },
    },
  },
  ...
  ent_enterprise_setting: {
    label: '企业设置',
    fields: {
      enterprise_address:     { label: '企业地址', type: 'STRING' },
      unit_address:           { label: '单位地址', type: 'STRING' },
      postal_code:            { label: '邮政编码', type: 'STRING' },
      fax:                    { label: '传真', type: 'STRING' },
      legal_representative:   { label: '法定代表人姓名', type: 'STRING' },
      legal_phone:            { label: '联系电话', type: 'STRING' },
      enterprise_contact:     { label: '企业联系人', type: 'STRING' },
      enterprise_mobile:      { label: '手机号', type: 'STRING' },
      enterprise_email:       { label: '电子邮件', type: 'STRING' },
      compiler_contact:       { label: '编制单位联系人', type: 'STRING' },
      compiler_mobile:        { label: '编制单位手机号', type: 'STRING' },
      compiler_name:          { label: '编制单位名称', type: 'STRING' },
      compiler_email:         { label: '编制单位电子邮件', type: 'STRING' },
      energy_cert:            { label: '是否通过能源管理体系认证', type: 'NUMBER' },
      cert_authority:         { label: '认证机构', type: 'STRING' },
      registered_capital:     { label: '单位注册资本(万元)', type: 'DECIMAL' },
      registered_date:        { label: '单位注册日期', type: 'DATE' },
      cert_pass_date:         { label: '通过日期', type: 'DATE' },
      industry_category:      { label: '行业分类', type: 'DICT' },
      industry_code:          { label: '行业代码', type: 'DICT' },
      industry_name:          { label: '行业名称', type: 'DICT' },
      superior_department:    { label: '上级主管部门', type: 'DICT' },
      unit_nature:            { label: '单位性质', type: 'DICT' },
      energy_enterprise_type: { label: '用能企业类型', type: 'DICT' },
      remark:                 { label: '备注', type: 'STRING' },
    },
  },
